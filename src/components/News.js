...
export class News extends Component {
    ...
    constructor() {
      ...
      async componentDidMount(){
        let url="https://newsapi.org/v2/top-headlines?country=us&category=technology&apiKey=64c969a073c94603bb4efc9e179b071e&page=1&pageSize=15"
       ...
       handleNextClick= async()=>{
        ...
        let url=`https://newsapi.org/v2/top-headlines?country=us&category=technology&apiKey=64c969a073c94603bb4efc9e179b071e&page=${this.state.page+1}&pageSize=15`    
        let data= await fetch(url);
        let parsedata= await data.json();
        ...
        return (
            <>
                <div className="container my-3">
                    ...
                    <div className="row">
                        <h2><strong>Daily Akhbar:</strong>Todays Top US  Technology HeadLines</h2>
